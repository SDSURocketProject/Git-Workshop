...
\noindent
\texttt{git branch mybranch}\verb+                   +- Create a new branch named ``mybranch''\\
\texttt{git checkout mybranch}\verb+                 +- Switch the working directory to the new branch\\
